...
_EMOTIONAL_NOISE_RE = re.compile(
    ...
    r"пожалуйста|плиз|спс|спасибо|благодарю|срочно|asap|sos|караул|помогите|спасите|"
    r"шеф ругается|начальник ругается|все пропало|всё пропало|ничего не работает|горит|"
