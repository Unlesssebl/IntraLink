...
export type Page = 'queue' | 'settings' | 'timeline' | 'reports';
...
export const scenarioBadgeConfigs: Record<string, ScenarioBadgeConfig> = Object.fromEntries(
  Object.entries(SCENARIO_REGISTRY).map(([key, meta]) => [
    key,
    {
