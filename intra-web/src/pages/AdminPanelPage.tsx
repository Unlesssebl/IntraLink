      ...
      <div className="flex-1 max-w-5xl w-full mx-auto p-6 md:p-8 space-y-6">
        ...
        {activeTab === 'ai-hub' && (
          <div className="space-y-6">
            ...
            {/* Карточка жизненного цикла триажа */}
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 shadow-sm space-y-3 mt-6">
              <div className="flex items-center justify-between flex-wrap gap-3">
                <div>
                  <h3 className="text-sm font-semibold text-neutral-100 flex items-center gap-2">
                    <span>Жизненный цикл анализа заявок (Ревизия логики)</span>
                  </h3>
                  <p className="text-xs text-neutral-400 mt-1 max-w-2xl">
                    Источник истины вердиктов хранится в базе данных (<code className="text-blue-400 font-mono">decision_records</code>). Для инвалидации устаревших решений при изменении правил используется инкремент параметра <code className="text-blue-400 font-mono">ANALYSIS_REVISION</code> в конфигурации сервера.
                  </p>
                </div>
              </div>
            </div>
