...
export default function UnifiedDecisionPanel({
  ...
  const consequences =
    ...
    `Статус заявки изменится на «${targetStatusName}»${replyText.trim() ? `, комментарий будет ${replyMode === 'internal' ? 'служебным' : 'доступен заявителю'}` : ''
  ...
  return (
    ...
    <div className="border border-neutral-200 dark:border-neutral-800 rounded-2xl bg-white dark:bg-neutral-900 shadow-sm overflow-hidden flex flex-col space-y-3 p-4">
        ...
        <div className="flex items-center justify-between gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex bg-neutral-100 dark:bg-neutral-800 p-0.5 rounded-lg border border-neutral-200 dark:border-neutral-700 text-[11px] font-semibold">
              ...
              <button
                ...
                className={`min-h-9 px-2.5 rounded-md outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 ${ticketRun?.mode !== 'autopilot'
              ...
              <button
                ...
                className={`min-h-9 px-2.5 rounded-md outline-none transition-colors flex items-center gap-1 focus-visible:ring-2 focus-visible:ring-blue-500 ${ticketRun?.mode === 'autopilot'
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="inline-flex min-h-9 items-center gap-1.5 px-2.5 text-[11.5px] font-medium text-neutral-600 hover:text-neutral-900 dark:text-neutral-300 dark:hover:text-neutral-100 bg-neutral-50 dark:bg-neutral-800/80 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 disabled:opacity-50 cursor-pointer"
            ...
            >
              ...
              <span>{reanalyzing ? 'Анализ...' : hasAnalysisResult ? 'Перезапустить анализ' : 'Проанализировать'}</span>
      ...
      {loadingDetails && !details ? (
        ...
        <div className="p-3 rounded-xl bg-neutral-50/80 dark:bg-neutral-900/80 border border-neutral-200 dark:border-neutral-800 flex items-center justify-between gap-3 text-xs text-neutral-500 animate-pulse">

          <div className="flex items-center gap-2">

            <IconRefresh size={14} className="animate-spin text-blue-500 shrink-0" />

            <span>Загрузка контекста и решения по заявке...</span>
      ...
      <div className="space-y-2.5">
        ...
        <div className="flex items-center justify-between gap-2 flex-wrap">
          ...
          <div className="flex bg-neutral-100 dark:bg-neutral-800 p-0.5 rounded-lg border border-neutral-200 dark:border-neutral-700 text-xs font-semibold" aria-label="Видимость комментария">
            ...
            <button
              ...
              className={`min-h-9 px-3 rounded-md outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 ${replyMode === 'reply'
            ...
            <button
              ...
              className={`min-h-9 px-3 rounded-md outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 ${replyMode === 'internal'
        ...
        {/* Баннер конфликта черновика при повторном анализе */}

        {pendingNewAiDraft && (

          <div className="p-2.5 rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50/70 dark:bg-blue-950/30 flex flex-col gap-2">

            <div className="flex items-center justify-between text-xs flex-wrap gap-2">

              <span className="font-semibold text-blue-900 dark:text-blue-200">

                Доступен новый вариант ответа AI после повторного анализа
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  onClick={() => setShowDraftCompare((prev) => !prev)}

                  className="px-2 py-0.5 rounded text-[11px] font-medium border border-blue-300 dark:border-blue-700 bg-white dark:bg-neutral-800 text-blue-700 dark:text-blue-300 hover:bg-blue-50 dark:hover:bg-neutral-750 cursor-pointer"

                >

                  {showDraftCompare ? 'Скрыть' : 'Сравнить'}
                ...
                <button
                  ...
                  onClick={applyNewDraft}

                  className="px-2 py-0.5 rounded text-[11px] font-semibold bg-blue-600 text-white hover:bg-blue-700 cursor-pointer"
                ...
                <button
                  ...
                  onClick={dismissNewDraft}

                  className="px-1.5 py-0.5 rounded text-[11px] text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300 cursor-pointer"

                  title="Оставить текущий черновик"
            ...
            {showDraftCompare && (
              ...
              <div className="grid grid-cols-2 gap-2 text-xs pt-1 border-t border-blue-100 dark:border-blue-900">

                <div>

                  <div className="font-semibold text-neutral-500 text-[10.5px] uppercase mb-1">Текущий черновик:</div>

                  <div className="p-2 rounded bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 whitespace-pre-wrap text-[11.5px] max-h-36 overflow-y-auto font-sans">
                ...
                <div>
                  ...
                  <div className="font-semibold text-blue-600 dark:text-blue-400 text-[10.5px] uppercase mb-1">Новый вариант AI:</div>

                  <div className="p-2 rounded bg-white dark:bg-neutral-900 border border-blue-200 dark:border-blue-800 whitespace-pre-wrap text-[11.5px] max-h-36 overflow-y-auto font-sans">
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              ...
              {details?.ai_suggested_resolution && (
                ...
                <button
                  ...
                  title="Вставить подготовленный ответ AI"
      ...
      <details className="group pt-2 border-t border-neutral-100 dark:border-neutral-800 space-y-2.5">

        <summary className="flex items-center justify-between cursor-pointer py-1.5 px-2 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-850 text-neutral-600 dark:text-neutral-400 font-semibold text-xs outline-none focus-visible:ring-2 focus-visible:ring-blue-500 list-none">

          <span className="flex items-center gap-2">

            <IconSparkles size={13} className="text-neutral-400 group-hover:text-blue-500 transition-colors" />

            <span>Как получено решение</span>

            {ticket.analysis?.freshness === 'stale' && (

              <span className="text-[10.5px] px-1.5 py-0.2 rounded bg-amber-100 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 font-medium">
            ...
            {ticket.analysis?.freshness === 'unknown' && (

              <span className="text-[10.5px] px-1.5 py-0.2 rounded bg-neutral-200 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 font-medium">
            ...
            {ticket.analysis?.decision_version && (
              ...
              <span className="text-[10px] font-mono text-neutral-400 dark:text-neutral-500">
                ...
                v{ticket.analysis.decision_version}
          ...
          <IconChevronDown size={14} className="text-neutral-400 transition-transform duration-200 group-open:rotate-180" />

        </summary>



        {/* Информационная полоса ревизии и сценария */}

        <div className="flex items-center gap-2 p-2 rounded-lg bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 text-[11px] text-neutral-600 dark:text-neutral-400 flex-wrap">

          <span className="font-semibold text-neutral-900 dark:text-neutral-100">

            Сценарий: {envelope?.scenario_key || details?.suggested_action?.rule_type || 'consultation'}

          </span>

          <span>•</span>

          <span>Ревизия правил: Rev {details?.analysis?.analysis_revision || '1'}</span>

          {ticket.analysis?.stale_reason && (

            <>

              <span>•</span>

              <span className="text-amber-700 dark:text-amber-300 font-medium">{ticket.analysis.stale_reason}</span>
          ...
          {ticket.analysis?.blocked_reason && (
            ...
            <>
              ...
              <span className="text-rose-600 dark:text-rose-400">{ticket.analysis.blocked_reason}</span>
        ...
        <div className="flex flex-nowrap items-center gap-1 overflow-x-auto border-b border-neutral-200 pb-1 text-xs dark:border-neutral-800">
          ...
          <button
            ...
            className={`flex min-h-9 shrink-0 items-center gap-1.5 rounded-lg px-3 font-semibold outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 ${selectedTab === 'facts'
          ...
          <button
            ...
            className={`flex min-h-9 shrink-0 items-center gap-1.5 rounded-lg px-3 font-semibold outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 ${selectedTab === 'rules'
          ...
          <button
            ...
            className={`flex min-h-9 shrink-0 items-center gap-1.5 rounded-lg px-3 font-semibold outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 ${selectedTab === 'diagnostics'
          ...
          <button
            ...
            className={`flex min-h-9 shrink-0 items-center gap-1.5 rounded-lg px-3 font-semibold outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 ${selectedTab === 'completeness'
          ...
          {selectedTab === 'ai' && (
            ...
            <div className="space-y-2.5">
              ...
              {details?.ai_suggested_resolution ? (
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="text-[11px] text-blue-600 hover:text-blue-700 dark:text-blue-400 font-medium inline-flex items-center gap-1 cursor-pointer disabled:opacity-50"

                        title="Перезапустить AI-анализ"

                      >

                        <IconRefresh size={11} className={reanalyzing ? 'animate-spin' : ''} />

                        <span>{reanalyzing ? 'Обновление...' : 'Обновить'}</span>
                ...
                <div className="py-2 text-neutral-400 flex items-center justify-between gap-2 text-xs">

                  <span>AI-анализ не использовался: предложение подготовлено по формализованному правилу</span>
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1 text-[11px] font-medium text-blue-600 dark:text-blue-400 hover:underline cursor-pointer disabled:opacity-50 shrink-0"

                  >

                    <IconRefresh size={11} className={reanalyzing ? 'animate-spin' : ''} />

                    <span>{reanalyzing ? 'Анализ...' : 'Запустить AI-анализ'}</span>
