        ...
        try:
            if job.state != JobState.WAITING_APPROVAL:
                ...
                if errors:
                    if len(errors) == 2:
                        error_msg = (
                            f"Здравствуйте! Не вижу ваш компьютер в сети ({job.target_pc}) и принтер ({job.printer_address}).\n\n"
                        ...
                        error_msg = (
                            f"Здравствуйте! Не вижу ваш компьютер в сети ({job.target_pc}).\n\n"
                        ...
                        error_msg = (
                            f"Здравствуйте! Не вижу принтер в сети ({job.printer_address}).\n\n"
                            "Пожалуйста, проверьте устройство:\n"
