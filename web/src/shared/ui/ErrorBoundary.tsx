...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center min-h-[260px] p-6 text-center bg-[#121316] border border-rose-900/40 rounded-lg my-4 max-w-xl mx-auto shadow-xl">
          ...
          <p className="text-xs text-rose-300/80 font-mono mt-2 mb-4 bg-rose-950/30 px-3 py-1.5 rounded border border-rose-800/30 max-w-full break-all">
