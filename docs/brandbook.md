...
### Таблица утвержденных иконок для действий:

| Действие / Сущность | SVG-контур | Запрещенный аналог |
|---|---|---|
| **Wi-Fi доступ (WLAN)** | Дуги радиосигнала (Wave arcs) | ⚡, 📶 |
| **Создание пользователя (AD)** | Силуэт пользователя со знаком `+` | ⚡, 👤, ➕ |
| **Редирект в сервис** | Стрелка перехода (Arrow Up-Right / Corner) | ↩️, 🔀, ↪️ |
| **Аппаратный ремонт (Каб. 112)** | Гаечный ключ / Системный блок | 🛠️, 🔧, 🔨 |
| **Дубликаты инцидентов** | Перекрывающиеся слои (Layers / Copy) | ⚠️, ❌, 👥 |
| **Синхронизация (Sync KB)** | Циклическая круговая стрелка | 🔄, ♻️, 🔃 |
| **RAG-поиск** | Интеллектуальный поиск / Sparkles / Lens | 🧠, 🤖, 💡 |
| **Переключение темы** | Контур солнца (Sun) / полумесяца (Moon) | ☀️, 🌙 |
