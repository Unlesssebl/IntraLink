...
При первом подключении эндпоинт выгружает последние 100 строк истории логов из Redis (для оптимизации производительности и во избежание зависания веб-интерфейса), после чего транслирует новые сообщения из Pub/Sub.
...
### 7. Удаление задания установки
Полностью удаляет задачу и всю историю её логов из базы данных Redis.
