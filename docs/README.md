...
## Текущий этап: Web UI и автопилот

**Ближайшая реализация:** [прозрачный триаж и журнал решений](decision-audit/README.md). В отдельной папке собраны требования, план и приёмка; этот этап создаёт основания для оценки Rule Engine, RAG, AI и автопилота перед переработкой Web UI.
...
3. [План реализации и приёмка](web-autopilot/implementation-plan.md) — этапы, рамки изменений и проверяемые результаты.
