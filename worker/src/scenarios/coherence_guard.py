...
logger = logging.getLogger("worker.scenarios.coherence_guard")
...
SCENARIO_SIGNALS = {
    ...
    "ad_password_reset": ["парол", "забыл пароль", "сброс пароля", "учетка заблокирована", "доменн", "active directory", "разблокировать"],
