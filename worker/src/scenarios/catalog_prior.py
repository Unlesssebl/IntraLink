...
logger = logging.getLogger("worker.scenarios.catalog_prior")
...
SERVICE_ID_MAPPINGS: Dict[int, Tuple[str, float, str]] = {
    ...
    # 23 = Сброс пароля / Учетные записи Active Directory
    23: ("ad_password_reset", 0.95, "ServiceId 23 (Active Directory Password Reset)"),
...
SERVICE_NAME_PATTERNS = [
    ...
    (("парол", "доменн", "active directory", "разблокировк"), "ad_password_reset", 0.90, "Service name relates to AD account/password"),
